...
class FFC_BN_ACT(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,
                 ...
                 padding_type='reflect', use_convolutions=False, enable_lfu=True, **kwargs):
...
class FFCResnetBlock(nn.Module):
    def __init__(self, dim, padding_type, norm_layer, activation_layer=nn.ReLU, dilation=1,
                 inline=False, use_convolutions=False, **conv_kwargs):
        super().__init__()
        self.conv1 = FFC_BN_ACT(dim, dim, kernel_size=3, padding=dilation, dilation=dilation, norm_layer=norm_layer,
                                ...
                                use_convolutions=use_convolutions, **conv_kwargs)
...
class Fourbi(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
                 ...
                 skip_connections='none', unet_layers=0):
        assert (n_blocks >= 0)
        super().__init__()
